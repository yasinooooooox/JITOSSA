...
mentionedJid: [user],    
externalAdReply: {
title: action === 'add' ? 'DATE TIME USER JOIN :' : 'DATE TIME USER LEAVE :',
body: botdate,
thumbnailUrl: ppgc,
sourceUrl: action === 'add' ? 'https://wa.me/' + user.split`@`[0] + `?text=Selamat+Datang+Di+Group+*${gcname}*+Semoga+Betah` : 'https://wa.me/' + user.split`@`[0] + `?text=Ko+Keluar+Group+*${gcname}*+Sih+Bang+Tapi+Gpp+Deh+Semoga+Sehat+Selalu`,
mediaType: 1,
renderLargerThumbnail: true 
}}}, { quoted: null})
                        }
...
externalAdReply: {
title: namebot,
thumbnailUrl: 'https://telegra.ph/file/360e8032ee880a34459c4.jpg',
mentionedJid: [m.sender], 
mediaType: 1,
renderLargerThumbnail: true
}}})
